...
#  end
  ...
  def self.deal_scale_graph(deal_discounts, deals_bought, image)
    ...
    customers_discount_ranges += "</colorRange><pointers><pointer value='#{deals_bought}' color='ab0f14' bgColor='FFFFFF' sides='4' toolText='Keupons Bought: #{deals_bought}'/></pointers>"
