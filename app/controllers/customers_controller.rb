...
class CustomersController < ApplicationController
  ...
  before_filter :login_required, :only => [:invite_friends, :buy_deal, :transaction_details,:save_transaction_details,:get_location_deal,:want_a_deal, :my_keupons,:change_password]
