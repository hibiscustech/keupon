ActionController::Routing::Routes.draw do |map|
  ...
  map.deal_transaction_success '/deal_transaction_success/:id', :controller => 'deals', :action => 'deal_transaction_success'
  map.deal_transaction_success '/deal_transaction_success', :controller => 'deals', :action => 'deal_transaction_success'
